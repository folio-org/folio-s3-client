...
public class S3ClientFactory {
  ...
  /**
   * Returns {@link FolioS3Client} implementation based on value of {@link
   * S3ClientProperties}#isAwsSdk() value.
   *
   * @param s3ClientProperties - S3 client properties
   * @return {@link AwsS3Client} if {@link S3ClientProperties}#isAwsSdk() is true, otherwise -
   *     {@link MinioS3Client}
   */
