...
class PutObjectAdditionalOptionsTest {
  ...
  void testEmptyGivesNoHeaders() {
    Map<String, String> headers =
        PutObjectAdditionalOptions.toMinioHeaders(PutObjectAdditionalOptions.builder().build());
  ...
  void testContentHeaders() {
    Map<String, String> headers =
        PutObjectAdditionalOptions.toMinioHeaders(
            PutObjectAdditionalOptions.builder()
